                                    ...
                                    @forelse ($instansi as $item)
                                        <tr>
                                            ...
                                            <td class="d-flex gap-2">
                                                <a href="{{ route('instansi.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                                                <form action="{{ route('instansi.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?')">
                                                    @csrf
                                                    @method('delete')
